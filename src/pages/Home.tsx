            ...
            <section className="relative pt-10 pb-16 lg:pt-24 lg:pb-32">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            <motion.div 
                                className="relative rounded-xl overflow-hidden shadow-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800"
            ...
            <section className="py-12 bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-wrap justify-center gap-8 md:gap-12 opacity-75 grayscale hover:grayscale-0 transition-all duration-500">
                        ...
                        <img src="/icons/python-svgrepo-com.svg" className="h-8 md:h-10 hover:scale-110 transition-transform cursor-pointer" title="Python" />
                        <img src="/icons/sql-database-sql-azure-svgrepo-com.svg" className="h-8 md:h-10 hover:scale-110 transition-transform cursor-pointer" title="SQL" />
                        <img src="/icons/pandas.svg" className="h-10 md:h-12 hover:scale-110 transition-transform cursor-pointer" title="Pandas" />
                        <img src="/icons/powerbi.svg" className="h-8 md:h-10 hover:scale-110 transition-transform cursor-pointer" title="Power BI" />
                        <img src="/icons/tableau.svg" className="h-8 md:h-10 hover:scale-110 transition-transform cursor-pointer" title="Tableau" />
                        <img src="/icons/excel.svg" className="h-8 md:h-10 hover:scale-110 transition-transform cursor-pointer" title="Excel" />
                        <img src="/icons/git.svg" className="h-8 md:h-10 hover:scale-110 transition-transform cursor-pointer" title="Git" />
                    </div>
                </div>
            </section>
            ...
            <section className="py-16 bg-gray-50 dark:bg-gray-800/50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                        {/* Project 1: UIDAI */}
                        <motion.a 
                            href="https://github.com/Vatsalsrivastava1209/UIDAI-Maintenance-Framework" 
                            target="_blank" 
                            rel="noopener noreferrer" 
                            className="bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-md border border-gray-100 dark:border-gray-700 p-6 block h-full flex flex-col"
                            whileHover={{ scale: 1.05, boxShadow: "0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1)" }}
                            transition={{ type: "spring", stiffness: 300 }}
                        >
                            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">UIDAI Aadhaar Risk Framework</h3>
                            <p className="text-gray-600 dark:text-gray-400 text-sm mb-4 leading-relaxed flex-grow">Built composite risk index using K-means clustering and Prophet forecasting. Identified high-risk districts via interactive Plotly dashboards.</p>
                        ...
                        {/* Project 2: RCA */}
                        <motion.a 
                            href="https://github.com/Vatsalsrivastava1209/Investigating-an-Engagement-Collapse-After-a-Recommendation-Model-Update" 
                            target="_blank" 
                            rel="noopener noreferrer" 
                            className="bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-md border border-gray-100 dark:border-gray-700 p-6 block h-full flex flex-col"
                            whileHover={{ scale: 1.05, boxShadow: "0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1)" }}
                        ...
                        >
                            ...
                            <p className="text-gray-600 dark:text-gray-400 text-sm mb-4 leading-relaxed flex-grow">Analyzed 17% watch time drop using SQL & Python hypothesis testing and segmentation to identify model deployment issues.</p>
                            <div className="flex flex-wrap gap-2">
                        ...
                        {/* Project 3: E-Com */}
                        <motion.a 
                            href="https://github.com/Vatsalsrivastava1209/E-Commerce-Customer-Behavior-and-Sales-Insights-Dashboard" 
                            target="_blank" 
                            rel="noopener noreferrer" 
                            className="bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-md border border-gray-100 dark:border-gray-700 p-6 block h-full flex flex-col"
                            whileHover={{ scale: 1.05, boxShadow: "0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1)" }}
                        ...
                        >
                            ...
                            <p className="text-gray-600 dark:text-gray-400 text-sm mb-4 leading-relaxed flex-grow">Power BI dashboard for £9.75M sales analysis across 4,373 customers. Enabled strategic market decisions via deep segmentation.</p>
                            <div className="flex flex-wrap gap-2">
                        ...
                        <motion.a 
                            href="https://github.com/Vatsalsrivastava1209" 
                            target="_blank" 
                            rel="noopener noreferrer" 
                            className="bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-md border border-gray-100 dark:border-gray-700 p-6 block h-full flex flex-col"
                            whileHover={{ scale: 1.05, boxShadow: "0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1)" }}
                        ...
                        >
                            ...
                            <p className="text-gray-600 dark:text-gray-400 text-sm mb-4 leading-relaxed flex-grow">Automated tiered commission calculations, rep summaries, and error reduction systems.</p>
                            <div className="flex flex-wrap gap-2">
                        ...
                        <motion.a 
                            href="https://github.com/Vatsalsrivastava1209/Superstore-sales-analysis" 
                            target="_blank" 
                            rel="noopener noreferrer" 
                            className="bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-md border border-gray-100 dark:border-gray-700 p-6 block h-full flex flex-col"
                            whileHover={{ scale: 1.05, boxShadow: "0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1)" }}
                        ...
                        >
                            ...
                            <p className="text-gray-600 dark:text-gray-400 text-sm mb-4 leading-relaxed flex-grow">Revenue, leads, and cost tracking system with advanced filters and management views.</p>
                            <div className="flex flex-wrap gap-2">
                                <span className="px-2 py-1 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs rounded-full font-medium">Excel</span>
